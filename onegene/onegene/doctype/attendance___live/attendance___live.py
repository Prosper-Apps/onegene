...
def get_data_system(dept, desn):
    ...
    if dept == "1":
        ...
        data += "<tr><td style='border: 1px solid black;background-color:#FFA500;font-weight:bold;text-align:center'>Designation</td><td style='border: 1px solid black;background-color:#FFA500;font-weight:bold;text-align:center'>Staff</td><td style='border: 1px solid black;background-color:#FFA500;font-weight:bold;text-align:center'>Operators</td><td style='border: 1px solid black;background-color:#FFA500;font-weight:bold;text-align:center'>Trainee</td><td style='border: 1px solid black;background-color:#FFA500;font-weight:bold;text-align:center'>CL</td><td style='border: 1px solid black;background-color:#FFA500;font-weight:bold;text-align:center'>Total</td></tr>"
        total = 0
        for d in designation:
            ...
            cl = cl_count[0].count if cl_count else 0
            total += (staff+ops+trainee+cl)
            data += "<tr><td style='border: 1px solid black;text-align:left'>%s</td><td style='border: 1px solid black;text-align:center'>%s</td><td style='border: 1px solid black;text-align:center'>%s</td><td style='border: 1px solid black;text-align:center'>%s</td><td style='border: 1px solid black;text-align:center'>%s</td><td style='border: 1px solid black;text-align:center'>%s</td></tr>" % (d.name,staff,ops,trainee,cl,(staff+ops+trainee+cl))
        data += "<tr><td colspan = 5 style='border: 1px solid black;text-align:left'>Total</td><td style='border: 1px solid black;text-align:center'>%s</td></tr>" % (total)
        data += "</table>"
    return data
