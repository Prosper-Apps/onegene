...
def get_ot_data():
    ...
    if op_ot_hours[0]['bal'] is None:
        op_ot_hours[0]['bal']=0
    ot_tot=app_ot_hours[0]['ot']+con_ot_hours[0]['ot']+ op_ot_hours[0]['ot']
    bal_tot=op_ot_hours[0]['bal']+con_ot_hours[0]['bal']+app_ot_hours[0]['bal']
    coff_tot=con_ot_hours[0]['coff']+op_ot_hours[0]['coff']+app_ot_hours[0]['coff']
    data=[]
    data.append({'mon':curr_month,'opot':op_ot_hours[0]['ot'],'appot':app_ot_hours[0]['ot'],
    'conot':con_ot_hours[0]['ot'],'ottot':ot_tot,'opcoff':op_ot_hours[0]['coff'],'appcoff':app_ot_hours[0]['coff'],
    'concoff':con_ot_hours[0]['coff'],'cofftot':coff_tot,
    'obal':op_ot_hours[0]['bal'],'appbal':app_ot_hours[0]['bal'],'conbal':con_ot_hours[0]['bal'],'baltot':bal_tot})
    return data